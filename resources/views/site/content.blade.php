                        ...
                        <div class="inner_section">
                            <div class="row">
                                <div class=" col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                                    {{--<img src="" class="img-circle delay-03s animated wow zoomIn" alt="">--}}
                                    {!!
                                        Html::image('assets/img/' . $page->images, '', [
                ...
                <!-- Portfolio Item -->
                    <div
                        style="position: absolute; left: 0px; top: 0px;
                                transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                        class="portfolio-item one-four {{ $portfolio->filter }} isotope-item">
                        <div class="portfolio_img">
                            <img src="/assets/img/{{ $portfolio->images }}" alt="{{ $portfolio->name }}">
                        </div>
                ...
                @foreach($peoples as $k=>$people)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{ $k*3 + 3 }}s">
                            ...
                            <img src="/assets/img/{{ $people->images }}" alt="{{ $people->name }}">
                            <ul>
